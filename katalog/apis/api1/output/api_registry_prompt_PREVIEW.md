...
- ``example_response`` should be a realistic sample matching the schema.
- Output **only** the raw JSON object — no markdown fences, no commentary.


# USER

Generate the API registry JSON entry for **api1** (date: 2026-03-03).
...
(no supplementary docs available)
